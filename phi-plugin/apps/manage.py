...
restartpu = on_alconna(Alconna(rf"re:{recmdhead}\s*repu"), priority=5, block=True)

backup = on_alconna(
    Alconna(rf"re:{recmdhead}\s*backup(\s*back)?"), priority=5, block=True
)

restore = on_alconna(Alconna(rf"re:{recmdhead}\s*restore"), priority=5, block=True)

get = on_alconna(Alconna(rf"re:{recmdhead}\s*get"), priority=5, block=True)
